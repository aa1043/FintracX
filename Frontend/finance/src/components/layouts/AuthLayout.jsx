...
const AuthLayout = ({ children }) => {
  return (
    <div className="flex">
      ...
      <h1 className="text-3xl font-bold text-black tracking-tight">FinTrackX</h1>
        {children}
      </div>
      <div className="hidden md:block w-[40vw] h-screen bg-violet-50 bg-auth-bg-img bg-cover bg-no-repeat bg-cover overflow-hidden p-8 relative">
        ...
        <StatsInfoCard
        icon={<LuTrendingUpDown size={26} color="purple" />}
